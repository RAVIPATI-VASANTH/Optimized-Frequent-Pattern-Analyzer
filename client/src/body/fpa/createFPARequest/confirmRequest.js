...
export default class ConfirmRequest extends Component {
    ...
    render() {
        return (<>
                ...
                <input type="text" value={this.state.requestName} onChange={(event)=>this.setState({requestName:event.target.value})} />
                <br/>
                <label>Minimum Support</label>
                <input type="text" value={this.state.minSupport} onChange={(event)=>this.setState({minSupport:Number(event.target.value)})} />%
                <br/>
                <label>Minimum Confidence</label>
                <input type="text" value={this.state.minConfidence} onChange={(event)=>this.setState({minConfidence:Number(event.target.value)})} />%
                <br/>
                <label>Status</label>
                ...
                <input type="checkbox" value={this.state.discountStatus} onClick={()=>{this.setState({
