...
const getData=()=>{
    ...
    for(let i=1;i<=75;i++){
        ...
        for(let j=1;j<=catogoryItemCount;j++){
            ...
            let currentItem={"categoryName":`Category ${i}`,"itemName":`Item ${itemSequenceNumber++}`,"itemBrand":brandsList[randomInt(1,brandsList.length)],"itemPrices":priceList};
            itemsList.push(currentItem);
        }
        let currentCollection={"userId":userId,"categoryName":`Category ${i}`,"itemsList":itemsList};
